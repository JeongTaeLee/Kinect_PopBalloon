...
public:
    ...
    /// <summary>
    /// 창 메시지를 처리하고 처리 할 클래스 인스턴스로 대부분 전달합니다.
    /// </summary>
...
private:
    ...
    double                  m_fFreq;				// Frame
    INT64                   m_nNextStatusTime;		// 다음 상태 시간
    ...
    /// <summary>
    /// 필요한 Direct2d 리소스가 만들어 졌는지 확인하십시오.
    /// </summary>
    ...
    /// </summary>
    void DiscardDirect2DResources(); // Release
